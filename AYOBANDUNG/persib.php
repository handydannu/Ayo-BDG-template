  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<header>
		<div class="header">
	        <div class="invisible"></div>
		        <div class="topleftlogo">            
		            <img class="piclogo" src="assets/img/persib.png" alt="AyoBandungCom">
		            <div class="datetoday">
		        ...
		        <div class="menu">
		        <nav>
					<div class="persib"></div>
		            <ul class="wisatakuliner">
	    ...
	    <article>
            ...
            <div class="invisible"></div>
            <div class="titlebar yellowline">BERITA LAINNYA</div>
            <?php
				for ($count = 1; $count <= 5; $count++)
					{
					echo ("
