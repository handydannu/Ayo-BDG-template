...
<div class="container"><!-- Main container -->
			...
			<div class="row"><!-- ROW 1 -->
				...
				<div class="col-sm-10">
					...
					<div class="row headatas">
							<div class="col-sm-6">	
								<a href="#"><img src="image/logo.png" width="300px" height="70px"></a>
								<div class="tglpost">
				    ...
				    <div class="row"><!-- ROW 2 -->
						<div class="col-sm-2"><!-- Inner left ROW 2 -->	
						...
						<div class="col-sm-6 sideborder"><!-- Inner center ROW 2 -->	
							  ...
							  <div class="carousel-inner">
							    <div class="item active">
							      ...
							      <div class="carousel-caption2">
							          <a href="single.php"><h3>CONTOH SINGLE PAGE</h3></a>
							...
							<!-- Terkini -->
							<div class="masthead"><!-- NAV Masthead terkini -->
						        <nav>
						        <div class=" judulmenu">TERKINI</div>						
							...
							<?php
								...
								echo ("
									<div class='row'>
									<div class='col-sm-6 imgpost img-responsive'>
							...
							<div class="toggler selengkapnya">
									<center>SELENGKAPNYA</center>
							<div>
								<!-- Thumbnail konten more -->
									<?php
										for ($count = 1; $count <= 10; $count++)
										{
										echo ("
						...
						<div class="carouselfoto">
							<div class="judulmenu linekuning">FOTO</div>						
						<!-- start carousel -->
					    <div class="container">
						  <div class='row'>
						    <div class='col-sm-12'>
						...
						<div class="carouselvideo">
							<div class=" judulmenu linekuning">VIDEO</div>						
						<!-- start carousel -->
					    <div class="container">
						  <div class='row'>
						    <div class='col-sm-12'>
						      <div class="carousel slide media-carousel" id="video">
						        <div class="carousel-inner">
						          <div class="item  active">
						            <div class="row">
						              <div class="col-sm-4">
						        ...
						        <a data-slide="prev" href="#video" class="left carousel-control">‹</a>
						        <a data-slide="next" href="#video" class="right carousel-control">›</a>
						      </div>                          
						    </div>
						  </div>
						</div><!-- end carousel -->
						...
						<div class="col-sm-4"><!-- Inner right ROW 2 -->
						...
						<div class="row">
							<div class="col-sm-5 imgpost img-responsive">
	...
	<div class="row"><!-- Row ads bottom -->
		...
		<div class="col-sm-5 bannerbottom1 img-responsive">
			<a href="#"><img src="http://placehold.it/450x70" title="Banner Bottom"></a>
		</div>
		<div class="col-sm-5 img-responsive bannerbottom2">
			<a href="#"><img src="http://placehold.it/450x70" title="Banner Bottom"></a>
		</div>
		<div class="col-sm-1"></div>		
	...
	<div class="row"><!-- Row footer -->
		...
		<div class="col-sm-7 bannerbottom1 img-responsive sideborder2">
		...
		<div class="col-sm-3 sideborder2"><br>
			<div class="sosialmedia"><!-- Social media -->
							Find us on : 
							<a href="#"><i class="fa fa-twitter" style="color:#5C5C5C"></i><a/>
							<a href="#"><i class="fa fa-facebook" style="color:#5C5C5C"></i><a/>
