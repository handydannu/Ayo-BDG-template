			...
			<div class="row"><!-- ROW 1 -->
				...
				<div class="col-md-10">
					...
					<div class="row headatas">
							<div class="col-md-6">
								<img src="image/logo.png" width="300px" height="70px">
								<div class="tglpost">
							...
							<div class="col-md-6">
								<br>
								<img src="http://placehold.it/400x75">
							</div>						
					...
					<div class="masthead"><!-- NAV Masthead -->
					        <nav>
					          <ul class="nav animatedunderlinemenu">
					            <li class="active"><a href="index.php">HOME</a></li>
					            <li id="nama"><a href="news.php">NEWS</a>							        
				    ...
				    <div class="row"><!-- ROW 2 -->
						...
						<div class="row">
							<div class="col-md-2">
								<div class="shareaholic-canvas" data-app='share_buttons' data-app-id='24047123'></div>								
							</div>
							...
							<div class="col-md-10">
								...
								<div class="imgpost img-responsive">
									<img src="http://placehold.it/380x220">
								</div>						
								<div class="captionfoto">
									Nam sagittis ante nec mi feugiat feugiat. Vivamus hendrerit condimentum ex, 
									vitae suscipit tellus laoreet vitae. Pellentesque sit amet varius ligula, 
									sed maximus urna. Donec vel enim sit amet enim auctor pharetra. 
									Phasellus vitae finibus nisi.
								</div>
								<div class='sideborder6'></div>
								<div class="mainteks">
								<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
								Nam sagittis ante nec mi feugiat feugiat. Vivamus hendrerit condimentum ex, 
								vitae suscipit tellus laoreet vitae. Pellentesque sit amet varius ligula, 
								sed maximus urna. Donec vel enim sit amet enim auctor pharetra. 
								Phasellus vitae finibus nisi. Donec tincidunt, ante pretium gravida elementum, 
								nisl ex fringilla diam, a maximus risus urna finibus neque. 
								Sed viverra ligula id massa consequat rhoncus.<br><br>

								Fusce mi lorem, ultrices aliquam aliquam eget, tristique eget quam. 
								Integer rutrum finibus odio, vel mattis elit viverra a. 
								Maecenas vehicula accumsan efficitur. 
								Praesent sit amet ex quis purus dapibus 
								gravida eget a dui. Aliquam imperdiet euismod metus, 
								sed varius lacus venenatis in. Duis nisl risus, porttitor sed sapien ac, 
								elementum vehicula velit. Etiam sit amet imperdiet velit.<br><br>

								Praesent condimentum, nisi in facilisis rhoncus, mauris purus maximus est, 
								sed commodo erat nunc sed purus. Sed ut ultrices elit, maximus volutpat sapien. 
								Donec leo est, ullamcorper ut arcu vel, laoreet porta urna. Morbi feugiat id erat 
								vitae consectetur. Curabitur quis nunc dolor. Lorem ipsum dolor sit amet, consectetur 
								adipiscing elit. Phasellus semper tortor sit amet tellus venenatis sollicitudin. 
								Maecenas consequat tellus molestie tincidunt facilisis. Praesent id neque vitae quam 
								gravida efficitur. Cras eu tellus vel dolor gravida semper. Quisque lectus lorem, 
								aliquet non dui et, tempus efficitur sem.<br><br>

								Vestibulum pulvinar augue eu tincidunt aliquet. Nam dapibus rutrum diam, 
								a facilisis tellus tincidunt ut. Pellentesque eu dapibus tortor, quis gravida lacus. 
								Donec in tincidunt nulla. Mauris non viverra orci. Cras ultricies tristique scelerisque. 
								Etiam pharetra justo sed sagittis sodales. Pellentesque habitant morbi tristique senectus 
								et netus et malesuada fames ac turpis egestas. Aliquam in dui id tellus imperdiet scelerisque. Sed sed velit vitae sem eleifend convallis et in turpis. 
								semper lectus eget faucibus consequat.
								</p>
								</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6"><!-- news -->
								<div class=" judulmenu linekuning">NEWS</div>
								<div class="imgpost img-responsive">
									<img src="http://placehold.it/200x120">
								</div>																
								<div class="judulpost3">
									<?php
										for ($count = 1; $count <= 5; $count++)
										{
										echo ("											
											<a href='#'>LOREM IPSUM SIR AMET DOLOR</a>
											");
										}
									?>
								</div>
							...
							<div class="col-md-6">	
								<div class=" judulmenu linekuning">KOMUNITAS</div>
								<div class="imgpost img-responsive">
									<img src="http://placehold.it/200x120">
								</div>																
								<div class="judulpost3">
						...
						<div class="row">
							<div class="col-md-6"><!-- news -->
								<div class=" judulmenu linekuning">WISATA</div>
								<div class="imgpost img-responsive">
									<img src="http://placehold.it/200x120">
								</div>																
								<div class="judulpost3">
							...
							<div class="col-md-6">	
								<div class=" judulmenu linekuning">PERSIB</div>
								<div class="imgpost img-responsive">
									<img src="http://placehold.it/200x120">
								</div>															
								<div class="judulpost3">
						...
						<div class="fb-comments" data-href="http://ayobandung.com" data-width="450" data-numposts="5"></div>
						...
						<!-- Terpopuler -->
						<div class="populer">
							<div class="linekuning judulmenu">TERPOPULER</div>
							<div class="imgpost img-responsive">
						...
						<div class="displaykecil img-responsive"><!-- display kecil -->
